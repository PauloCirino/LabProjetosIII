...
def draw_new_menu_item(	img, init_x, init_y, info = 'personal_information',
	...
	cv2.rectangle(	img, 
					pt1 = (init_x, init_y),
	 				pt2 = (init_x + clickable_rectangle_x, init_y + y_size), 
	 				color = (0, 255, 0),
	 				thickness = -1)
...
class person:
	...
	def get_info(self, info_name):
		...
		if info_name in self.infoType :
			ret = True
			val = self.dict[info_name]
	...
	def get_main_info_pretty(self):
		ret_string = ''
		for info_name in self.infoTypes :
			ret_string = ret_string + str(info_name) + '\n'
...
class people:
	...
	def get_person_info_all(self, person_name):
		ret_flag = False
		ret_val = 'Unknown Person'
		
		if person_name in self.people_dict.keys():
			[ret_flag, ret_val] = self.people_dict[person_name].get_all_info()

		return [ret_flag, ret_val]

	def get_person_info_specific(self, person_name, info_name):
		if person_name in self.people_dict.keys():
			return self.people_dict[person_name].get_info(info_name = info_name)
		return [False, 'Unknown Person']

	def get_person_main_info_pretty(self, person_name):
		ret_flag = False
		ret_val = 'Unknown Person'
		
		if person_name in self.people_dict.keys():
			[ret_flag, ret_val] = self.people_dict[person_name].get_main_info_pretty()
		return [ret_flag, ret_val]
...
if __name__ == "__main__":
	...
	people_json_dir = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/data/json"

	casc_path = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/util/haarcascade_frontalface_default.xml"
	
	classifier_model_path = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/generateSnaps/features/classifier.pkl"
	dlib_face_predictor_path = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/models/dlib/shape_predictor_68_face_landmarks.dat"
	open_face_model_dir = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/models/openface"
	network_model_path = "/Users/paulocirino/Desktop/Facudade/LabProjetosIII/./models/openface/nn4.small2.v1.t7"
